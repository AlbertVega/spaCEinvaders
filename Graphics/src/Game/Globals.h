...
#define GAME_SCREEN_WIDTH 840
#define GAME_SCREEN_HEIGHT 820
...
#define BUNKER_WIDTH 16
#define BUNKER_HEIGHT 8

#define NUM_SHOOTS 50
#define NUM_BUNKERS 4
#define NUM_ALIENS 55
#define NUM_ALIENS_ROW 11
#define NUM_ALIENS_COLUMN 5
#define NUM_SQUID 11
#define NUM_CRAB 22
#define NUM_OCTOPUS 22

/*
    GLOBAL COLORS
*/
#define green (Color){ 0x15, 0xFF, 0x14, 0xFF}
#define blue (Color){ 0x28, 0xFD, 0xE7, 0xFD}
#define pink (Color){ 0xC9, 0x0B, 0xD3, 0xD3}
